...
import cn.jiayuli.spring.implement.HelloServiceImpl;
...
public class HelloServiceTest {
    ...
    public void testHello() {
        ...
        Hello helloJava = context.getBean("helloJava", Hello.class);
        Hello helloPython = (Hello) context.getBean("helloPython");
        helloJava.sayHello();
