 ...
 */
package cn.jiayuli.wechat.crypt;
...
public class WXBizMsgCrypt {
	...
	public WXBizMsgCrypt(String token, String encodingAesKey, String appId) throws AesException {
		if (encodingAesKey.length() != WXConstant.ENCODING_AES_KEY_LENGTH) {
	...
	public String encryptMsg(String replyMsg, String timeStamp, String nonce) throws AesException {
		...
		// 生成发送的xml
		String result = null;//XMLParse.generate(encrypt, signature, timeStamp, nonce);
		return result;
	}
	...
	public String decryptMsg(String signature, String timeStamp, String nonce, String postData)
		...
		// 验证安全签名
		String mySignature = CryptUtil.signature(token, timeStamp, nonce);
		...
		// 解析xml格式为map
		Map<String, String> map = XMLParseUtil.xmlToMap(postData);

		// 解密
		String result = map.toString();//decrypt(encrypt[1].toString());
		return result;
	}
